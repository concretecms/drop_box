...
namespace Concrete\Package\DropBox\Controller\Element\Dashboard\Files\DropBox\Search;
...
class Search extends ElementController
{
    ...
    {
        return 'dashboard/files/drop_box/search/search';
    }
    ...
    public function view()
    {
        ...
        if (isset($this->headerSearchAction)) {
            ...
            $this->set('headerSearchAction', $this->app->make('url')->to('/dashboard/files/drop_box'));
        }
